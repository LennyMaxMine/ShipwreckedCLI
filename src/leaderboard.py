...
def generate_leaderboard(data, top_n: int = 10, highlight_name: str = None):
    leaderboard = []
    ...
    print_leaderboard_table(top_users, highlight_name, highlighted_rank, leaderboard)

def print_leaderboard_table(leaderboard, highlight_name: str = None, highlighted_rank: int = None, full_leaderboard: list = None):
    if not leaderboard:
